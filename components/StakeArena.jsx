...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .btn-s{background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:13px 20px;color:#fff;font-family:'Barlow Condensed',sans-serif;font-size:15px;font-weight:700;letter-spacing:1px;text-transform:uppercase;cursor:pointer;}
  ...
  .back-btn{display:flex;align-items:center;gap:6px;color:rgba(255,255,255,0.5);font-family:'IBM Plex Mono',monospace;font-size:11px;cursor:pointer;margin-bottom:18px;letter-spacing:.5px;background:none;border:none;padding:0;}
...
const Loading = () => (
  <div className="loading-overlay"><div className="loading-dots"><span /><span /><span /></div></div>
);
...
const Splash = () => (
  <div className="splash">
    ...
    <div className="splash-sub">Play. Stake
